...
module("Elise", package.seeall, log.setup)
clean.module("Elise", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/ShulepinElise.lua", "1.0.7")
