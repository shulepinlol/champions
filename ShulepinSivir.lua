...
module("Shulepin Sivir", package.seeall, log.setup)
clean.module("Shulepin Sivir", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/shulepinlol/champions/main/ShulepinSivir.lua", "1.0.5")
