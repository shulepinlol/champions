...
module("DrMundo", package.seeall, log.setup)
clean.module("DrMundo", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/ShulepinDrMundo.lua", "1.0.7")
