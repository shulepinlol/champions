...
module("Shulepin Irelia", package.seeall, log.setup)
clean.module("Shulepin Irelia", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/shulepinlol/champions/main/ShulepinIrelia.lua", "1.0.8")
