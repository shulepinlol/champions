...
module("Shulepin Cassiopeia", package.seeall, log.setup)
clean.module("Shulepin Cassiopeia", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/shulepinlol/champions/main/ShulepinCassiopeia.lua", "1.0.6")
