if Player.CharName ~= "Samira" then return end

module("Shulepin Samira", package.seeall, log.setup)
clean.module("Shulepin Samira", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/shulepinlol/champions/main/ShulepinSamira.lua", "1.0.6")
