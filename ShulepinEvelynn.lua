...
module("Evelynn", package.seeall, log.setup)
clean.module("Evelynn", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/ShulepinEvelynn.lua", "1.0.7")
