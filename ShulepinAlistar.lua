...
module("Shulepin Alistar", package.seeall, log.setup)
clean.module("Shulepin Alistar", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/shulepinlol/champions/main/ShulepinAlistar.lua", "1.0.5")
