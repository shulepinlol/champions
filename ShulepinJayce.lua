...
module("Jayce", package.seeall, log.setup)
clean.module("Jayce", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/ShulepinJayce.lua", "1.0.7")
