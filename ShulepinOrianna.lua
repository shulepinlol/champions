...
module("Orianna", package.seeall, log.setup)
clean.module("Orianna", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/ShulepinOrianna.lua", "1.0.10")
