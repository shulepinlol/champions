...
module("Shulepin Zeri", package.seeall, log.setup)
clean.module("Shulepin Zeri", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/shulepinlol/champions/main/ShulepinZeri.lua", "1.0.9")
