...
module("Syndra", package.seeall, log.setup)
clean.module("Syndra", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/ShulepinSyndra.lua", "1.0.10")
