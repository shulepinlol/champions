...
module("Poppy", package.seeall, log.setup)
clean.module("Poppy", clean.seeall, log.setup)
CoreEx.AutoUpdate("https://raw.githubusercontent.com/hagbardlol/Public/main/ShulepinPoppy.lua", "1.0.7")
